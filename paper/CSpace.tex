...
\begin{figure}[H]
  \begin{tabular}{cc}
    ...
    \subfloat[SMACOF]{\includegraphics[height = 2in]{rec-rdk-smacof}}\\
    \subfloat[Non-metric MDS]{\includegraphics[height = 2in]{rec-rdk-nmmds}} &
...
\begin{figure}[H]
  \centering
  \begin{tabular}{cc}
    \subfloat[RDKit/MDS]{\includegraphics[height = 2in]{sp-rdk-mds}} &
    \subfloat[RDKit/TSNE]{\includegraphics[height = 2in]{sp-rdk-tsne}}\\
    \subfloat[Gobbi/MDS]{\includegraphics[height = 2in]{sp-gobbi-mds}} &
